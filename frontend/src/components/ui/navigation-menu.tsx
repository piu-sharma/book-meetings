...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "tw-relative tw-z-10 tw-flex tw-max-w-max tw-flex-1 tw-justify-center",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "tw-group tw-flex tw-flex-col tw-flex-1 tw-list-none tw-items-center tw-justify-start tw-space-x-1",
      className
    )}
    {...props}
  />
